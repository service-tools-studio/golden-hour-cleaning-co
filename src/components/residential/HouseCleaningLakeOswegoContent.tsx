...
const FAQS = [
  {
    question: "How much does house cleaning cost in Lake Oswego?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. We offer weekly, biweekly, and custom recurring cleaning options for Lake Oswego-area homes.",
  },
  {
    question: "Do you clean apartments and condos?",
    answer:
      "Yes. We clean houses, apartments, condos, townhomes, and residential properties throughout the Lake Oswego area.",
  },
];

export default function HouseCleaningLakeOswegoContent() {
  return (
    <>
      <section
        id="hero"
      ...
      >
        ...
        <div className="relative w-full bg-amber-50 lg:min-h-[46rem]">
          <Image
            src="/assets/house-cleaning-lake-oswego.png"
            alt="Bright Lake Oswego living room with lake views after a professional Golden Hour house cleaning"
            width={1536}
            height={1024}
          ...
          <div className="mx-auto w-full max-w-6xl lg:pointer-events-auto">
            <div className="lg:max-w-4xl">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#dcbb52] lg:text-amber-200">
                Lake Oswego Residential Cleaning Services
              </p>
              <h1
                className={`mt-3 text-3xl leading-tight md:text-4xl lg:text-3xl lg:text-white lg:drop-shadow-md ${HEADING_UPPER}`}
              >
                House Cleaning in Lake Oswego, OR
              </h1>
              <p className="mt-4 text-lg leading-8 text-stone-700 lg:text-base lg:leading-7 lg:text-white/95 lg:drop-shadow-md">
                From lakeside homes in First Addition and Lake Grove to hillside neighborhoods like Palisades, Forest Highlands, and Mountain Park, Lake Oswego homeowners expect a cleaning experience that matches the care they put into their homes. Golden Hour Cleaning Co. delivers recurring house cleaning, deep cleaning, and move-out cleaning with meticulous attention to detail, clear communication, and genuine respect for your space.
              </p>
              <div className="mt-6">
                <a
                  href="#services"
            ...
            <div className="mt-8 flex w-screen max-w-[100vw] justify-center [margin-left:calc(50%-50vw)] [margin-right:calc(50%-50vw)]">
              <p className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-white/90 px-4 py-2 text-center text-sm font-medium text-stone-700 lg:border-white/25 lg:bg-white/10 lg:text-white/95 lg:drop-shadow-md">
                ...
                Trusted by Busy Lake Oswego Professionals and Families.
              </p>
            </div>
          </div>
      ...
      <section className="bg-white px-5 py-16 md:px-10">
        <div className="mx-auto max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#dcbb52]">
            Thoughtfully Caring for Homes Across Lake Oswego
          </p>
          <h2 className={`mt-3 text-3xl leading-tight md:text-4xl ${HEADING_UPPER}`}>
            Helping Lake Oswego Homes Feel Their Best
          </h2>
      ...
      <section id="services" className="mx-auto max-w-6xl px-4 py-16 md:px-6">
        ...
        <p className="mt-2 max-w-2xl text-stone-700">
          Choose the level of care your Lake Oswego home needs — from recurring upkeep to
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 md:px-6">
        <h2 className={`text-3xl ${HEADING_UPPER}`}>
          Serving Lake Oswego and nearby neighborhoods
        </h2>
      ...
      <section className="bg-[#333333] px-5 py-16 text-center text-white md:px-10">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-4 text-lg leading-relaxed text-white/85">
            Book your Lake Oswego house cleaning with Golden Hour Cleaning Co. today.
          </p>
          <Link
      ...
      <section className="mx-auto max-w-3xl px-4 py-16 md:px-6">
        <Section title="House Cleaning Lake Oswego FAQs">
