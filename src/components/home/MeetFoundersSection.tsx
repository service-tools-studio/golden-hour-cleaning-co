    ...
    >
      <div className={SECTION_INNER}>
        ...
        <div className="mt-12 flex justify-center">
          <figure className="w-full max-w-[320px] overflow-hidden rounded-3xl border border-amber-200 shadow-sm sm:max-w-[380px]">
            <Image
        ...
        <blockquote className="mx-auto mt-12 max-w-2xl text-center text-sm leading-relaxed text-stone-700 sm:text-base">
