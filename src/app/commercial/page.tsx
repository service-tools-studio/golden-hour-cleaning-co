// Revamped commercial page inspired by flyer aesthetic
        ...
        <div className="mx-auto max-w-7xl px-6 pt-10 pb-6 sm:pt-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
            ...
            <div className="flex items-center gap-3 sm:pt-1">
              <Link
                href="/residential"
                className="text-sm font-semibold uppercase tracking-wide text-stone-700 underline-offset-4 hover:underline"
              >
                Residential
              </Link>
              <a
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-10">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              ...
              <h1 className="mt-6 text-4xl sm:text-6xl font-semibold leading-[0.95] tracking-tight">
      ...
      <section id="spaces" className="py-24">
        <div className="mx-auto max-w-7xl px-6 grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-[40px] bg-[#dcbb52] p-10 text-stone-900 shadow-xl">
            ...
            <h3 className="mt-4 text-5xl font-semibold leading-tight">
